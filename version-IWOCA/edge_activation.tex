...
Section~\ref{sec:greedy} discusses the greedy algorithm, and
Section~\ref{sec:parameterized} states some parameterized and exact algorithms for {\xxxNTP}.
...
must have exactly $4n$ edges (and must actually be a spanning tree). Furthermore, the activity interval of every edge is contained in $[0, \beta]$.
...
and semi-connected during each of the remaining six time slots. \qed
\end{enumerate}
\end{lemma}
...
Problem {\xxxNTP} is strongly NP-hard, even if all edge weights are in $\fromto{1}{6}$. \qed
\end{restatable}
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
solves the {\xxxNTP} instance $(G,w)$ to optimality. \qed
\end{enumerate}
\end{theorem}
%%%%%%%%%%%%%%%%%
...
If both the treewidth and the maximum edge weight of the input graph $G = (V, E)$ are bounded, problem {\xxxNTP} allows for an FPT-algorithm whose running time is linear in $|E|$. \qed
\end{restatable}

\begin{restatable}{theorem}{exactAlgoExponential}
\label{th:exact}
On input graphs $G=(V,E)$, problem {\xxxNTP} is solvable in exponential time $\bigO(|E|^2\cdot|E|!)$. \qed
\end{restatable}
...
There is a kernel with $\bigO(k)$ vertices and edges. \qed
\end{restatable}
...
Then an optimal solution can be found in $\bigO(k^{2k}m^3)$ time. \qed
\end{restatable}
%%%%%%%%%%%%%%%%%%
...
%
%
%\paragraph{\textbf{Proof of \cref{lemma:gadgets_properties}.}}
...
%
%%\weightsOneToSix*
%\paragraph{\textbf{Proof of \cref{coro:small-weights}.}}
...
%\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\paragraph{\textbf{Proof of \cref{th:greedy.cactus}.}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Proofs of the Theorems from \cref{sec:parameterized}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%\fptBoundedWeightAndTW*
%\paragraph{\textbf{Proof of \cref{th:fpt_weights_and_tw_bounded}.}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%\exactAlgoExponential*
%\paragraph{\textbf{Proof of \cref{th:exact}.}}
...
%
%%\fptFeedbackEdge*
%\paragraph{\textbf{Proof of \cref{thm:FPT_feedback_edge_set}}.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%%\fptAlmostAllWeightOne*
%\paragraph{\textbf{Proof of \cref{th:fpt_almost_all_weight_one}}.}
