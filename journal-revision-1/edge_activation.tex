...
\begin{figure}[htpb]
\centering
 \includegraphics[scale=1.1]{act-hamilton-cycle-b-simplified}
\qquad\qquad\qquad
 \includegraphics[scale=1.1]{act-hamilton-cycle-c}
...
Stefan Lendl is cofounder of s2 data \& algorithms GmbH.
